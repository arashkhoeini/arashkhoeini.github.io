...
![alt text](../assets/img/ssl-balancedness.png)
...
![alt text](../assets/img/ssl-context-prediction.png)
...
![alt text](../assets/img/ssl-context-prediction-2.png)
...
![alt text](../assets/img/ssl-context-prediction-network.png)
...
![alt text](../ssl-jigwsaw-tiger.png)
...
![alt text](../assets/img/ssl-jigsaw-network.png)
...
![alt text](../assets/img/ssl-contrastive.png)
...
![alt text](../assets/img/ssl-contrastive-collapse.gif)
...
![alt text](../assets/img/ssl-barlow-twins.png)
...
![alt text](../assets/img/ssl-byol.png)
